...
app.controller('ejemploCtrl', function($scope){
  ...
  for (let index = 0; index < data.length; index++) {
    $scope.datadefL[index]= data[index].home_team.country;
    $scope.datadefV[index]= data[index].away_team.country;
    $scope.datadefLB[index]= "http://www.countryflags.io/"+data[index].home_team.code2+"/flat/64.png";
    $scope.datadefVB[index]= "http://www.countryflags.io/"+data[index].away_team.code2+"/flat/64.png" ;
  }
  $scope.datadef = "Hola Mundo";
  $scope.ejemplo3 = $scope.datadefL;
  $scope.ejemplo4 = $scope.datadefV;
  $scope.ejemplo5 = data[0].home_team.country;
